...
<Notes>
  <p>We used a wiping task to evaluate the performance of our framework. The wiping task is a contact-rich task that requires the robot to maintain contact with the surface while applying a consistent force. The robot must also be able to adapt to different surface textures and shapes.</p>
</Notes>
