...
import midlle_wiping from "../assets/midlle_wiping.mp4"
...
<TwoColumns>
  <Figure slot="left">  
    <Image slot="figure" source={Diff_Shapes1} altText="Framework" />
    <span slot="caption">Different Line Shapes.</span> 
  </Figure>
  <Figure slot="right">
    <Image slot="figure" source={up_wiping} altText="Framework" />
...
<TwoColumns>
  ...
  <Figure slot="right">
    <Image slot="figure" source={midlle_wiping} altText="Framework" />
    <span slot="caption">Different Line Pisitions.</span>
  </Figure> 
</TwoColumns>
...
<TwoColumns>
  ...
  <Figure slot="right">
    <Image slot="figure" source={down_wiping} altText="Framework" />
    <span slot="caption">Different Line Pisitions.</span>
  </Figure> 
</TwoColumns>
...
<TwoColumns>
  <Figure slot="left">  
    <Image slot="figure" source={chipFail} altText="Framework" />
    <span slot="caption">Failure Case.</span> 
  </Figure>
  <Figure slot="right">
    <Image slot="figure" source={chipSuccess} altText="Framework" />
