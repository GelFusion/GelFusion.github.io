...
import GithubNote from '../components/GithubNote.astro';
...
import Diff_Shapes2 from "../assets/Diff_Shapes2.mp4"
import Diff_Shapes3 from "../assets/Diff_Shapes3.mp4"
import Bad_Alignment from "../assets/Bad_Alignment.mp4"
import Collision from "../assets/Collision.mp4"
import Float_Wiping from "../assets/Float_Wiping.mp4"
import Overpress from "../assets/Overpress.mp4"
...
<Header
  ...
  links={[
    ...
    {
      name: "Code",
      url: "https://github.com/GelFusion/GelFusion",
      icon: "ri:github-line",
    },
    {
      name: "arXiv",
...
<TwoColumns>
  <Figure slot="left">  
    <Video slot="figure" source={Float_Wiping} altText="Framework" />
    <span slot="caption">Float Wiping.</span> 
  </Figure>
  <Figure slot="right">
    <Video slot="figure" source={Overpress} altText="Framework" />
...
<TwoColumns>
  <Figure slot="left">  
    <Video slot="figure" source={Diff_Shapes2} altText="Framework" />
    <span slot="caption">Different Line Shapes.</span> 
  </Figure>
  <Figure slot="right">
...
<TwoColumns>
  <Figure slot="left">  
    <Video slot="figure" source={Diff_Shapes3} altText="Framework" />
    <span slot="caption">Different Line Shapes.</span> 
  </Figure>
  <Figure slot="right">
...
<TwoColumns>
  <Figure slot="left">  
    <Video slot="figure" source={Bad_Alignment} altText="Framework" />
    <span slot="caption">Bad alignment.</span> 
  </Figure>
  <Figure slot="right">
    <Video slot="figure" source={Collision} altText="Framework" />
